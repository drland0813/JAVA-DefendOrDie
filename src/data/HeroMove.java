...
public class HeroMove implements Entity {
	...
	public HeroMove(int tileX, int tileY, TileGrid grid) {
	...
	public HeroMove(Texture texture, Tile startTile, TileGrid grid, int width, int height, float speed, float health) {
	...
	private void endofMazeReached() {
		...
		// System.out.println("Mang: " +Player.Lives);
		die();
	}
